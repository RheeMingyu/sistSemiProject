		...
		<form action="login/loginAction.jsp" method="post">
			<div class="user-box">
				<input type="text" name="id" required="required"
					value="<%=saveok == null ? "" : myid%>"> <label>ID</label>
			</div>
			<div class="user-box">
			...
			<button type="submit" class="btn btn-info"
				style="text-align: center; border: none; background: transparent; width: 100px; font-weight: bold; margin-left: 100px;">Enter</button>
			<br>
			...
			<div
				...
				<button type="button"
					style="border: none; background: transparent; width: 100px; font-weight: bold; margin-left: 8px;">
					<b style="font-size: 13px;">아이디찾기</b>
				</button>
				<button type="button"
					style="border: none; background: transparent; width: 110px; font-weight: bold; margin-left: 10px;">
					<b style="font-size: 13px;">비밀번호찾기</b>
				</button>
			</div>

			<a class="button-signup" href="index.jsp?main=member/Gaipform.jsp"><b>회원가입</b></a>

			<br> <br> <input type="checkbox" name="cbsave"
				<%=saveok == null ? "" : "checked"%>><b
				style="font-size: 14px;">아이디저장</b>&nbsp;&nbsp; <input
				type="checkbox" name="sesave" <%=sesave == null ? "" : "checked"%>><b
				style="font-size: 14px;">로그인상태유지</b>
		</form>
	</div>
