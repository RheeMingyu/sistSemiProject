	...
	<div>
		...
		<div class="container mt-3">
			...
			<ul class="nav nav-tabs left-tab">
				<li class="nav-item">
					<button type="button" class="btn btn-outline-info btn-sm v"><i class="bi bi-three-dots-vertical"></i></button>
				</li>&nbsp;
				<li class="nav-item">
					<button type="button" class="btn btn-outline-info btn-sm h"><i class="bi bi-three-dots"></i></button>
				</li>
			</ul>
