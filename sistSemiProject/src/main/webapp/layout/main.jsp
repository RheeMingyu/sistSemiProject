...
<div class="dv7" style="position: absolute; z-index: 0; height: 560px; top: 78px; width: 1690px;">
	<span style= "position: absolute; border-radius:20px 20px 20px 0px; padding-left:8px; background-color: black; color: white; padding-top: 3px; margin-left: 380px; margin-top: 150px; width: 140px; height: 30px; font-weight: 300;">제주를 아는 방법</span>
...
<div class="dv8" style="position: absolute; z-index: 0; height: 560px; top: 78px; width: 1690px;">
	<span style= "position: absolute; border-radius:20px 20px 20px 0px; padding-left:8px; background-color: black; color: white; padding-top: 3px; margin-left: 380px; margin-top: 150px; width: 140px; height: 30px; font-weight: 300;">제주 산책 맛집</span>
...
<div class="dv9" style="position: absolute; z-index: 0; height: 560px; top: 78px; width: 1690px;">
	<span style= "position: absolute; border-radius:20px 20px 20px 0px; padding-left:8px; background-color: black; color: white; padding-top: 3px; margin-left: 380px; margin-top: 150px; width: 140px; height: 30px; font-weight: 300;">제주의 공기</span>
...
<div class="dv10" style="position: absolute; z-index: 0; height: 560px; top: 78px; width: 1690px;">
	<span style= "position: absolute; border-radius:20px 20px 20px 0px; padding-left:8px; background-color: black; color: white; padding-top: 3px; margin-left: 380px; margin-top: 150px; width: 140px; height: 30px; font-weight: 300;">제주 바다 맛집</span>
